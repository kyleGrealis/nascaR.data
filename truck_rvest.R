...
for (season in season) {
  ...
  base_url <- 'https://www.racing-reference.info/season-stats/{season}/C/'
  ...
  # for (i in 1:10) {
    ...
    # Craftsman Truck Series race number 1 of 23
    # Friday, February 16, 2024 at Daytona International Speedway, Daytona Beach, FL
    # 100 laps* on a 2.500 mile paved track (250.000 miles)
    
    # Time of race: 2:33:08
    # Average speed: 98.933 mph
    # Pole speed: 178.767 mph	Cautions: 12 for 52 laps
  ...
  truck_series <- bind_rows(truck_series, season_table)
...
save(truck_series, file = 'data/rvest/truck_series.rda')
