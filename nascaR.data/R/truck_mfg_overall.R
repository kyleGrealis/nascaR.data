...
#' @description A collection of overall statistics for manufacturers in the NASCAR Truck Series. The data includes career totals and averages for various performance metrics.
