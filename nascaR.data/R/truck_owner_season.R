...
#'   \item{owner_season_cars_raced}{num: Total number of trucks raced by the owner in the season}
#'   \item{owner_season_truck_win_pct}{num: Win percentage at the truck level for the manufacturer in the season}
