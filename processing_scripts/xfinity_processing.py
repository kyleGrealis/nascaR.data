...
xfinity = (
  ...
  'finish', 'start', 'driver', 'car', 'car_number', 'owner', 'sponsor',
...
xfinity.write_csv('data/busch-xfinity-series/xfinity-results.csv')
driver_career.write_csv('data/busch-xfinity-series/xfinity-driver-career.csv')
driver_season.write_csv('data/busch-xfinity-series/xfinity-driver-season.csv')
owner.write_csv('data/busch-xfinity-series/xfinity-owner.csv')
