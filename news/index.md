...
- Error handling for placeholder race. The “DriverAverages.com” site
  will sometimes have one row for the upcoming race. This has routinely
  caused issues for the weekly scraping functions accidentally
...
- *BREAKING* CHANGES:
  ...
  - Reduced number of datasets for Cup, Xfinity, & Truck series results
    by series only.
